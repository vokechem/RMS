...
var PassportRedAlerts = express();
var mysql = require("mysql");
var config = require("./../../DB");
var con = mysql.createPool(config);
var auth = require("./../../auth");
PassportRedAlerts.get("/", function(req, res) {
...
PassportRedAlerts.get("/:ID/:Val1/:Val2/:Val3", function(req, res) {
...
module.exports = PassportRedAlerts;
