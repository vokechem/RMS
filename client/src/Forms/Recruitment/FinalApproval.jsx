...
class FinalApproval extends Component {
    constructor() {
        super();
        this.state = {
            open: false,
    ...
    fetchMyApplications = () => {
    fetch("/api/FinalMedicalApproval/" + localStorage.getItem("UserName"),{
      method: "GET",
      headers: {
    ...
    handleSubmit = event => {
        ...
        if (this.state.IsAccept){
            this.Approve("/api/FinalMedicalApproval", data);
        }
        if (this.state.IsDecline) {
            this.Decline("/api/FinalMedicalApproval", data);
        }
  ...
  notifyPanelmembers = (AproverMobile, Name, AproverEmail, IDNumber, Msg) => {        
    if (Msg == "Applicant") {         
        this.SendSMS(
            AproverMobile,
            "Dear " +Name + " Final Medical that you had submited to Job majuu has been Approved."
        );
        this.SendMail(
            Name,
            AproverEmail,
            "Final Medical Approval",
            "Final Medical approved",
            IDNumber,
...
Approve(url = ``, data = {}) {
      ...
      .then(response =>
          response.json().then(data => {                   
              ...
              if (data.success) {                   
                  ...
                  swal("", "Final medical Approved", "success");
  ...
  sendDeclineNotification = (Mobile, Name, Email, IDNumber)=>{
      this.SendSMS(
          Mobile,
          "Dear " +Name + " Final Medical that you had submited to Job majuu  has been declined."
      );
      this.SendMail(
          Name,
          Email,
          "Final Medical Declined",
          "Final Medical Declined",
          IDNumber,
          this.state.Remarks
      );
          ...
          .then(response =>
              response.json().then(data => {
                  ...
                  if (data.success) {                      
                      ...
                      swal("", "Final Medical Declined", "success"); 
                      this.fetchMyApplications();        
                ...
                return (
                    ...
                    <div class="content-wrapper">
                        <div class="content-header row">
                            ...
                            <h3 class="content-header-title float-left mb-0">Visa Medical Approval</h3>
                            </div>
                        ...
                        <div class="content-header row">
                            <div class="content-header-left col-md-9 col-12 mb-2">
                                <div class="row breadcrumbs-top">
                                    <div class="col-12">
                                        <h4 class="content-header-title float-left mb-0">Pending Final medical Approval</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
