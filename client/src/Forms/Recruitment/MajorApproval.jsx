...
class MajorApproval extends Component {
    constructor() {
        super();
        this.state = {
            open: false,
    ...
    fetchMyApplications = () => {
    fetch("/api/MajorApproval/" + localStorage.getItem("UserName"),{
      method: "GET",
      headers: {
    ...
    handleSubmit = event => {
        ...
        if (this.state.IsAccept){
            this.Approve("/api/MajorApproval", data);
        }
        if (this.state.IsDecline) {
            this.Decline("/api/MajorApproval", data);
        }
  ...
  notifyPanelmembers = (AproverMobile, Name, AproverEmail, IDNumber, Msg) => {        
    if (Msg == "Applicant") {         
        this.SendSMS(
            AproverMobile,
            "Dear " +Name + " Major Medical that you had submited to Job majuu has been Approved."
        );
        this.SendMail(
            Name,
            AproverEmail,
            "Major Medical Approval",
            "Major Medical Approved",
            IDNumber,
      ...
      .then(response =>
          response.json().then(data => {                   
              ...
              if (data.success) {                   
                  ...
                  swal("", "Major Medical Approved", "success");
          ...
          .then(response =>
              response.json().then(data => {
                  ...
                  if (data.success) {                      
                      ...
                      swal("", "Major Medical Declined", "success"); 
                      this.fetchMyApplications();        
