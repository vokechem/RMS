...
class DCICustom extends Component {
  constructor() {
    super();
    this.state = {
      Applications: [],
  ...
  Downloadfile = () => {
    if (this.state.Certificate_status) {
                      ...
                      <table className="table table-bordered table-sm">
                        ...
                        {this.state.Data.map((r, i) => (
                          <tr>
                            ...
                            >
                              {new Date(r.DOC).toLocaleDateString()}
                            </td>
                            <td
                              style={{ cursor: "pointer" }}
                            ...
                            >
                                {dateFormat(
                          new Date(r.DOT).toLocaleDateString(),
                          "fullDate"
                        )}
                            </td>
