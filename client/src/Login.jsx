...
class Login extends Component {
  ...
  render() {
    ...
    let back={
      ...
      weight: "100%",
      height: "760px",
      // background: "url(../../../app-assets/images/pages/dylan-nolte-CfN8BZn9jF8-unsplash.jpg) no-repeat  center fixed",
      background:"#E2F3F9"

    }
    return (
 <div className="cover"style={back}>
